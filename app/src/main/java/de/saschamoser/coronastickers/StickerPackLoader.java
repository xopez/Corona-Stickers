...
import static de.saschamoser.coronastickers.StickerContentProvider.ANDROID_APP_DOWNLOAD_LINK_IN_QUERY;
...
import static de.saschamoser.coronastickers.StickerContentProvider.STICKER_FILE_EMOJI_IN_QUERY;
import static de.saschamoser.coronastickers.StickerContentProvider.STICKER_FILE_NAME_IN_QUERY;
import static de.saschamoser.coronastickers.StickerContentProvider.STICKER_PACK_ICON_IN_QUERY;
import static de.saschamoser.coronastickers.StickerContentProvider.STICKER_PACK_IDENTIFIER_IN_QUERY;
import static de.saschamoser.coronastickers.StickerContentProvider.STICKER_PACK_NAME_IN_QUERY;
import static de.saschamoser.coronastickers.StickerContentProvider.STICKER_PACK_PUBLISHER_IN_QUERY;
import static de.saschamoser.coronastickers.StickerContentProvider.IMAGE_DATA_VERSION;
    ...
    private static List<Sticker> fetchFromContentProviderForStickers(String identifier, ContentResolver contentResolver) {
        ...
        if (cursor != null && cursor.getCount() > 0) {
            ...
            do {
                ...
                stickers.add(new Sticker(name, emojis));            } while (cursor.moveToNext());
        }
        if (cursor != null) {
            cursor.close();
        }
